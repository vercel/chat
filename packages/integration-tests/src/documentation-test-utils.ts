...
export const VALID_DOC_PACKAGES = [
  ...
  "@chat-adapter/teams",
  "@chat-adapter/gchat",
  "@chat-adapter/gchat/api",
  "@chat-adapter/gchat/cards",
  "@chat-adapter/gchat/format",
  "@chat-adapter/gchat/thread-id",
  "@chat-adapter/gchat/webhook",
  "@chat-adapter/gchat/workspace-events",
  "@chat-adapter/discord",
  "@chat-adapter/telegram",
  "@chat-adapter/github",
  "@chat-adapter/linear",
