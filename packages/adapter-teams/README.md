...
Anonymous downloads require HTTPS URLs on Microsoft 365 SharePoint or OneDrive for Business hosts. Redirects are revalidated and responses are limited to 25 MB. Override `createFetchDataFn()` in a subclass to support another trusted host.
