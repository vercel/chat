...
See [Overlapping Messages](/docs/concurrency) for strategies beyond dropping — queueing, debouncing, bursting, or processing messages concurrently.
...
<Cards>
  <Card title="Build an adapter" description="Implement a state adapter for subscriptions, locks, and caching." href="/docs/contributing/building" />
