...
The fastest way to get started is with `create-chat-sdk`. It scaffolds a complete Next.js bot project with your chosen adapters, environment variables, and webhook route.

<Cards>
  <Card title="create-chat-sdk" description="Scaffold a new Chat SDK bot project with a single command." href="/docs/create-chat-sdk" />
</Cards>
