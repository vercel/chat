...
On platforms with native table support (Teams, GitHub, Linear), tables render as formatted tables. Discord card payloads preserve GFM markdown tables. On other platforms (Slack, Google Chat, Telegram), tables render as padded ASCII text.
