...
- **Local mode**: Only supports sending/receiving messages and message history. Reactions, typing indicators, message editing, and thread fetching require remote mode.
