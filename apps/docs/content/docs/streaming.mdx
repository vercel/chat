...
Slack limits native streamed text fields to 12,000 characters and task or plan chunks to 256 characters. Chat SDK handles these limits automatically. Long text continues in ordered replies, long task details and output continue in additional task cards, and task or plan titles are shortened to fit.
