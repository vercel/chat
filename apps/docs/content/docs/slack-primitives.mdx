...
| `@chat-adapter/slack/api` | Fetch-based Slack Web API calls without `@slack/web-api` |
| `@chat-adapter/slack/blocks` | Runtime-free conversion from simple card objects to Slack Block Kit |
