...
The fastest way to start a new project is with `create-chat-sdk`:

```bash
npm create chat-sdk@latest my-bot
```

This scaffolds a Next.js app with your chosen adapters, environment variables, and a webhook route - ready to run. See the [create-chat-sdk docs](/docs/create-chat-sdk) for all options.
