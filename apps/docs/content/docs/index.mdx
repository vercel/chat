...
<Cards>
  ...
  <Card title="State Adapters" description="Persist thread subscriptions, distributed locks, and caches across restarts." href="/docs/state-adapters" />
</Cards>
...
<Cards>
  <Card title="Build an adapter" description="Implement the Adapter interface for any messaging platform or state backend." href="/docs/contributing/building" />
  <Card title="List a vendor-official adapter" description="How platform vendors qualify and list a maintained adapter in the Vendor Official tier." href="/docs/contributing/vendor-official" />
</Cards>
