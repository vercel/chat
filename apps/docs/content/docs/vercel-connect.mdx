...
description: Authenticate Slack, Discord, GitHub, Linear, Notion, Telegram, and Microsoft Teams adapters with Vercel Connect — short-lived runtime tokens for outbound calls and OIDC-verified inbound webhooks where supported.
type: overview
related:
  - /docs/usage
...
The trigger-forwarding steps below apply to Slack, Discord, GitHub, Linear, and Teams.
