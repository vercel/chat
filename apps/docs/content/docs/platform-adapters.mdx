...
| File uploads | <Check /> | <Check /> | <Cross /> | <Check /> | <Check /> Media groups | <Cross /> | <Cross /> | <Check /> Images, audio, docs | <Cross /> |
...
| Link buttons | <Check /> | <Check /> | <Check /> | <Check /> | <Warn /> Inline keyboard URLs | <Cross /> | <Cross /> | <Warn /> Single CTA URL | <Check /> |
