...
2. Under **1. Generate access tokens**, click **Add account** and sign in to
...
For an app that connects other businesses' accounts, configure **3. Set up
Instagram business login** and request these scopes in the login flow:
...
2. Under **2. Configure webhooks**, click **Configure**.
