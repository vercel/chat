...
<Callout type="info">
Building a custom Google Chat runtime? See the [Google Chat low-level APIs](/docs/google-chat-primitives) guide for webhook, REST API, Card v2, format, thread ID, and Workspace Events primitives.
</Callout>
