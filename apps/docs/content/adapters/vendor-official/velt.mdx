...
<PackageInstall package="@velt-js/chat-sdk-adapter" />
...
- Full walkthrough: [Get started with a Chat SDK bot using Velt](https://velt.dev/docs/integrations/chat-sdk-bot).
