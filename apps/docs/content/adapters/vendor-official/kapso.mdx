...
<TypeTable
  type={{
    ...
    baseUrl: {
      ...
      description: "Kapso WhatsApp proxy URL. Falls back to `KAPSO_BASE_URL`.",
    },
    client: {
      type: "WhatsAppClient",
      description: "Existing `@kapso/whatsapp-cloud-api` client. Use this when your app already shares a configured Kapso WhatsApp client.",
    },
...
1. Create or use a Kapso WhatsApp integration and copy your **API key**.
